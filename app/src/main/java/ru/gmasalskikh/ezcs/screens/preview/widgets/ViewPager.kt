...
//
//    val currentPagerState: PagerState
//        get() = state
//}
//
//@Composable
...
//
//                        val xItemOffset =
//                            ((page + offset - currentPage) * placeable.width).roundToInt()
//
//                        placeable.place(
...
//    pagerState: PagerState = getPagerState(),
//    items: List<I>,
//    content: @Composable (PagerScope, I) -> Unit
//) {
